(setq mu4e-headers-seen-mark '("S" . "☑")
      ...
      mu4e-compose-complete-ignore-address-regexp "no-?reply\\|\\(un\\)?subscribe\\|jira"

      mu4e-my-email-addresses "brobronsa@gmail.com"
      mu4e-user-mail-address-list '("brobronsa@gmail.com")
